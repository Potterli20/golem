...
import (
	zobservability "github.com/Potterli20/golem/pkg/zobservability"
...
//   - serviceName string
func (_e *MockobserverFactory_Expecter) Execute(config any, serviceName any) *MockobserverFactory_Execute_Call {
